...
var p2p = localStorage.getItem('P2p');
p2p = JSON.parse(p2p);
var p2 = p2p.P2;

var ani = localStorage.getItem('Ani');
ani = JSON.parse(ani);
var animal = ani.Ani;
...
var doit = {
  ...
  loadAnimation: function() {
    var person2, person1, animal1;
    if(p2 === "Dan"){
      person2 = "obj/man.js";
      person1 = "obj/woman.js";
    }
    else{
      person2 = "obj/woman.js";
      person1 = "obj/man.js";
    }
    ...
    if(animal === "dog"){
      ...
      animal1 = "obj/catnew.js";
    }

    var loader = new THREE.JSONLoader();

    loader.load( person1, function ( geometry, materials ) {
    ...
    loader.load( person2, function ( geometry, materials ) {
    ...
    loader.load( animal1, function ( geometry, materials ) {
          ...
          skinnedMesh = new THREE.SkinnedMesh(geometry, new THREE.MeshFaceMaterial(materials));
          skinnedMesh.position.set(0,-60,100);
          skinnedMesh.scale.set( 20, 20, 20 );
  ...
  draw3dText: function(x, y, z, text) {
      ...
      var theText = "They talked for a while and saw a " + animal + " coming by.";
